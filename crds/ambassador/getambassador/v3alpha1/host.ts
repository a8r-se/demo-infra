...
export interface HostArgs {
    ...
    kind?: pulumi.Input<"Host">;
    metadata?: pulumi.Input<ObjectMeta>;
    /**
     * HostSpec defines the desired state of Host
     */
    spec?: pulumi.Input<inputs.getambassador.v3alpha1.HostSpecArgs>;
    /**
     * HostStatus defines the observed state of Host
     */
    status?: pulumi.Input<inputs.getambassador.v3alpha1.HostStatusArgs>;
}
